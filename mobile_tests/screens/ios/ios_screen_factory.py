...
from mobile_tests.screens.ios.intro_screens.download_offline_map_popup import DownloadOfflineMapPopup
from mobile_tests.screens.ios.intro_screens.first_launch_screen import FirstLaunchScreen
from mobile_tests.screens.ios.intro_screens.intro_screen import IntroScreen
from mobile_tests.screens.ios.intro_screens.login_smart_pass_page_screen import LoginSmartPassPageScreen
from mobile_tests.screens.ios.intro_screens.login_screen import LoginScreen
from mobile_tests.screens.ios.intro_screens.login_uae_pass_page_screen import LoginUAEPassPageScreen
from mobile_tests.screens.ios.intro_screens.meet_home_pop_up_screen import MeetHomePopUpScreen
from mobile_tests.screens.ios.intro_screens.quick_tip_popup import QuickTipPopup
from mobile_tests.screens.ios.intro_screens.sop1_screen import Sop1Screen
from mobile_tests.screens.ios.main_screens.locker_screens.locker_screen import LockerScreen
from mobile_tests.screens.ios.main_screens.locker_screens.my_subscriptions_screens.feedback_screen import FeedbackScreen
from mobile_tests.screens.ios.main_screens.locker_screens.my_subscriptions_screens.my_subscriptions_screen import \
    MySubscriptionsScreen
from mobile_tests.screens.ios.main_screens.locker_screens.my_subscriptions_screens.new_subscription_screen import \
    NewSubscriptionScreen
from mobile_tests.screens.ios.main_screens.locker_screens.my_subscriptions_screens.package_details_screen import \
    PackageDetailsScreen
from mobile_tests.screens.ios.main_screens.locker_screens.my_subscriptions_screens.packages_screen import PackagesScreen
from mobile_tests.screens.ios.main_screens.locker_screens.my_subscriptions_screens.subscription_successful_screen \
    import SubscriptionSuccessfulScreen
from mobile_tests.screens.ios.main_screens.locker_screens.my_subscriptions_screens.summary_screen import SummaryScreen
from mobile_tests.screens.ios.main_screens.main_screen import MainScreen
from mobile_tests.screens.ios.intro_screens.tutorial_screen import TutorialScreen
from mobile_tests.screens.ios.main_screens.services_screens.adu_screens.adu_search_services_screen import \
    AduSearchServicesScreen
from mobile_tests.screens.ios.main_screens.services_screens.adu_screens.adu_services_screen import AduServicesScreen
from mobile_tests.screens.ios.main_screens.services_screens.pre_services_screen import BasePreServicesScreen, \
    PreServicesScreen
from mobile_tests.screens.ios.main_screens.services_screens.services_screen import ServicesScreen
from mobile_tests.screens.ios.main_screens.updates_screens.updates_screen import UpdatesScreen
from mobile_tests.screens.ios.system_popup_screen import SystemPopUpScreen
from mobile_tests.screens.ios.warning_popup_screen import WarningPopupScreen


class IosScreenFactory(ScreenFactory):
